...
function useful(r:any){const type=String(r.notification_type||"other"),src=String(r?.meta?.source||"");return !["capture_noise","like","follow","comment","creator_article_posted"].includes(type)&&/^note-notification-/.test(src)&&Boolean(clean(r.raw_text))}
