...
export const CURRENT_INSIGHT_APP_VERSION = "2026.09.22.6";
export const CURRENT_NOTIFICATION_VERSION = "3.6.4";
export const CURRENT_DASHBOARD_VERSION = "1.4.5";
export const CURRENT_DM_VERSION = "1.4.4";
