...
export const CURRENT_INSIGHT_APP_VERSION = "2026.09.22.12";
export const CURRENT_NOTIFICATION_VERSION = "3.6.8";
export const CURRENT_DASHBOARD_VERSION = "1.4.9";
export const CURRENT_DM_VERSION = "1.4.6";
