...
test("V3.6.3 loads split notification architecture",async()=>{
  ...
  for(const p of ["note-insight-notification-network-v3300.js?v=3630","note-insight-notification-reader-v4.js?v=3620","note-insight-notification-controls-v1.js?v=136","note-insight-notification-filter-v4.js?v=401","note-insight-notification-return-v1.js?v=120","note-insight-notification-status-bridge-v1.js?v=110","note-insight-notification-settings-bridge-v1.js?v=100","note-insight-notification-account-pair-v1.js?v=100"])assert.ok(v3.includes(p),p);
