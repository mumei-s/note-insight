...
test("V3.2.89 loads incremental reader, persistent checkpoint and fixed five-panel dock",async()=>{
  ...
  has(reader,["__mumeiNotificationReader323","__mumeiV3Reader323","readyToScan","confirmedClientSignatures","incremental-top-until-saved","top-until-first-saved-v329","ここまで保存済み","boundarySignature","boundaryEventIdentity","新しい通知だけ確認しています","findSavedRecoveryElement","persistRecoveredBoundary","preserveBoundary","全件読み直しなし"]);
