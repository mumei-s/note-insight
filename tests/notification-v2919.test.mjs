...
test("V3.6.9 loads split notification architecture",async()=>{
...
test("release tracks V3.6.9 without putting the version in the user-facing label",async()=>{
  ...
  assert.match(release,/CURRENT_INSIGHT_APP_VERSION = "2026\.09\.25\.1"/);assert.match(release,/CURRENT_NOTIFICATION_VERSION = "3\.6\.9"/);assert.match(v3,/@version\s+3\.6\.9/);
});
