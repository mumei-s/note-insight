...
test("V3.3.4 loads bottom-up reader and fixed five-panel runtime",async()=>{
 ...
 const reader=await read("public/note-insight-notification-reader-v323.js");
 assert.match(parent,/@version\s+3\.3\.4/);
 assert.match(parent,/note-insight-notification-reader-v323\.js\?v=3340/);
 assert.match(parent,/note-insight-notification-checkpoint-v325\.js\?v=3293/);
 assert.match(parent,/note-insight-notification-network-v3300\.js\?v=3340/);assert.match(parent,/note-insight-notification-runtime-v327\.js\?v=3340/);
