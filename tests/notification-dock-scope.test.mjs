...
test("V3.2.92 loads bottom-up reader and fixed five-panel runtime",async()=>{
 ...
 const reader=await read("public/note-insight-notification-reader-v323.js");
 assert.match(parent,/@version\s+3\.2\.92/);
 assert.match(parent,/note-insight-notification-reader-v323\.js\?v=3258/);
 assert.match(parent,/note-insight-notification-checkpoint-v325\.js\?v=3292/);
 assert.match(parent,/note-insight-notification-runtime-v327\.js\?v=3292/);
