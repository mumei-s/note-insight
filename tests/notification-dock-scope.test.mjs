...
test("V3.5.1 loads fully split notification modules",async()=>{
 ...
 assert.match(parent,/@version\s+3\.5\.1/);
 for(const p of [
  "note-insight-notification-network-v3300.js?v=3510",
    "note-insight-notification-reader-v4.js?v=3510",
