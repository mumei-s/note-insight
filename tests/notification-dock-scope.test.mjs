...
test("V3.6.0 loads fully split notification modules",async()=>{
 ...
 assert.match(parent,/@version\s+3\.6\.0/);
 for(const p of [
  "note-insight-notification-network-v3300.js?v=3600",
    "note-insight-notification-reader-v4.js?v=3600",
