...
test("V3.3.2 loads bottom-up reader and fixed five-panel runtime",async()=>{
 ...
 const reader=await read("public/note-insight-notification-reader-v323.js");
 assert.match(parent,/@version\s+3\.3\.2/);
 ...
 assert.match(parent,/note-insight-notification-network-v3300\.js\?v=3311/);assert.match(parent,/note-insight-notification-runtime-v327\.js\?v=3320/);
