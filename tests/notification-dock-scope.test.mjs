...
test("V3.2.59 loads bottom-up reader and fixed five-panel runtime",async()=>{
 ...
 assert.match(parent,/note-insight-notification-runtime-v327\.js\?v=3259/);
