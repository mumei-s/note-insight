...
test("OWNER favorite reader keeps the existing favorites and adds durable reading state", async () => {
  ...
  assert.match(reader, /action: "read_set"/);
  assert.match(reader, /currentPage === 1/);
