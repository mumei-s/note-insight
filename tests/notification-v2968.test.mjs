...
test('active package uses V3.6.3 split full/delta Reader',()=>{
  ...
  assert.equal(manifest.notificationVersion,'3.6.3');assert.equal(manifest.notificationLabel,'本人通知');
  assert.match(v3,/@version\s+3\.6\.3/);
  const meta=v3.split('// ==/UserScript==')[0];
  for(const p of ['note-insight-notification-network-v3300.js?v=3630','note-insight-notification-reader-v4.js?v=3620','note-insight-notification-controls-v1.js?v=136','note-insight-notification-filter-v4.js?v=401','note-insight-notification-return-v1.js?v=120','note-insight-notification-status-bridge-v1.js?v=110','note-insight-notification-feature-bridge-v1.js?v=100','note-insight-notification-settings-bridge-v1.js?v=100','note-insight-notification-account-pair-v1.js?v=100'])assert.ok(meta.includes(p),p);
