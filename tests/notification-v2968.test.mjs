...
test('active package uses V3.2.89 with bottom-up resume, persistent checkpoint and fixed five-panel auto dock',()=>{
  ...
  for(const part of ['note-insight-notification-reader-v323.js?v=3258','note-insight-notification-checkpoint-v325.js?v=3250','note-insight-notification-runtime-v327.js?v=3289'])assert.match(meta,new RegExp(part.replace(/[.?]/g,m=>'\\'+m)));
