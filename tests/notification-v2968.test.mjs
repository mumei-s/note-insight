...
test('active package uses V3.3.9 panel-free automatic full/delta reader',()=>{
  ...
  assert.equal(manifest.notificationVersion,'3.3.9');assert.equal(manifest.notificationLabel,'本人通知');
