...
test('notification and DM readers are hard separated with independent storage and APIs',()=>{
  ...
  assert.match(dmUser,/@version\s+1\.4\.5/);assert.match(dmUser,/note-insight-dm-account-pair-v1\.js\?v=100/);assert.match(dmUser,/note-insight-dm-network-v2\.js\?v=145/);assert.match(dmUser,/note-insight-dm-reader-v1\.js\?v=145/);
