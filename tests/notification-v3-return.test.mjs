...
test("installer entry redirects to isolated compact browser page",async()=>{
  ...
  assert.doesNotMatch(page,/script_installation\.php#url=|本人通知 V\d|V3\.3\.1/);
});

test("V3.3.1 preloads bottom-up reader, checkpoint and fixed five-panel runtime",async()=>{
