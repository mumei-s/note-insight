...
test("installer entry redirects to isolated compact browser page",async()=>{
  ...
  assert.doesNotMatch(page,/script_installation\.php#url=|本人通知 V\d|V3\.5\.7/);
});

test("V3.5.7 preloads split runtime modules",async()=>{
...
test("V3.5.7 supports checkpoint stop without losing partial progress",async()=>{
