...
test("V3.3.5 preloads bottom-up reader, checkpoint and fixed five-panel runtime",async()=>{
  ...
  assert.match(meta,/note-insight-notification-network-v3300\.js\?v=3350/);assert.match(meta,/note-insight-notification-reader-v323\.js\?v=3350/);assert.match(meta,/note-insight-notification-checkpoint-v325\.js\?v=3293/);assert.match(meta,/note-insight-notification-runtime-v327\.js\?v=3350/);assert.doesNotMatch(meta,/note-insight-notification-settings-route-v332\.js/);
  assert.doesNotMatch(meta,/note-insight-notification-dock-watch-v312\.js/);assert.match(meta,/note-insight-notification-manual-full-v3284\.js\?v=3350/);
