...
test("V3.2.8 returns version check before rescue or remote loading",async()=>{
...
test("remote parts load independently with dock before reader",async()=>{
  ...
  assert.match(v3,/mumei-notification-v328-component:/);
});
