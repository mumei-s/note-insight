...
test('manual full-read stays isolated from the 05:48 runtime core',async()=>{
  ...
  assert.match(v3,/note-insight-notification-manual-full-v3284\.js\?v=3340/);
...
test('network reader is primary and DOM reader is fallback',async()=>{
  ...
  assert.match(meta,/note-insight-notification-network-v3300\.js\?v=3340/);
