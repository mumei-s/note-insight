...
if (process.argv[1] === fileURLToPath(import.meta.url)) {
  if (process.argv.includes('--check')) {
    ...
    console.log('Built v18.8.20 standalone card userscript');
  }
}
