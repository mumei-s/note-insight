...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-insight-dm-network-v2.js?v=145
...
(function(){
'use strict';
const VERSION='1.4.5',KEY='mumei-dm-tool-version',GMKEY='mumei-dm-active-version-v1';
...
window.__mumeiDmPackage={version:VERSION,architecture:'durable-dm-v145'};
})();