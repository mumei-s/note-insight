...
// @version      1.1.0
// @description  INSIGHT DM同期。本人通知とは完全分離し、noteのDMを開くだけで自動同期します。
...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-insight-dm-reader-v1.js?v=110
...
(function(){
'use strict';
const VERSION='1.1.0',KEY='mumei-dm-tool-version',GMKEY='mumei-dm-active-version-v1';
