...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-insight-dm-reader-v1.js?v=133
...
(function(){
'use strict';
const VERSION='1.3.3',KEY='mumei-dm-tool-version',GMKEY='mumei-dm-active-version-v1';
...
window.__mumeiDmPackage={version:VERSION,architecture:'full-room-background-v133'};
})();