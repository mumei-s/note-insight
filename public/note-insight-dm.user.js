...
// @version      1.2.1
// @description  INSIGHT DM同期。noteの通常DM導線を変更せず、開いた一覧・会話だけを受動保存します。
...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-insight-dm-reader-v1.js?v=121
...
(function(){
'use strict';
const VERSION='1.2.1',KEY='mumei-dm-tool-version',GMKEY='mumei-dm-active-version-v1';
...
window.__mumeiDmPackage={version:VERSION,architecture:'passive-v2'};
})();