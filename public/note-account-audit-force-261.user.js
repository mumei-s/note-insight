...
// @downloadURL https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-account-audit-force-261.user.js
// @grant none
// @run-at document-start
// ==/UserScript==
(function(){
'use strict';window.__noteAccountAuditV1=1;window.__noteAccountAuditCanonical='2.6.1';
...
function render(r){
 ...
 if(lead){
   ...
   else{leadStatus='外部リンク由来の候補';leadNote='ID/リンク一致だけでは本人特定不可'}
 }
