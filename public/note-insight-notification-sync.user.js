...
// @version      2.9.50
// @description  前回保存位置まで通知欄を小分け自動走査して保存。画面を固めず停止可能。公開データ更新とは分離します。
...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-insight-notification-autoscan-v2950.js?v=2950a
