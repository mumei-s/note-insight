// ==UserScript==
// @name note こあく まこ調査 DASHBOARD v2.0
// @namespace https://github.com/mumei-s/note-insight
// @version 2.0.0
// @description 公開コメント・返信・スキ・フォロー関係とフォロワー構成を確認。本人同定は公開明示だけを根拠にします。
// @match https://note.com/*
// @updateURL https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-account-audit-v20.user.js
// @downloadURL https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-account-audit-v20.user.js
// @grant none
...
var PRESET_TARGET='koakumako',AUTO_KEY='note-account-audit:auto:koakumako:v200';
var PRESET_ARTS=[
