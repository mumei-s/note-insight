// ==UserScript==
// @name         note 巡回BOOST｜URL・#・マガジン v5.2.1
// @namespace    https://github.com/mumei-s/note-insight
// @version      5.2.1
// @description  URLまたは#から巡回。記事URLはスキした人から巡回、マガジンURLは追加先。既存スキを解除・二重送信せず、最初から/今回/完了を記録。24時間上限＋403/429適応リミッター、途中再開・自動復元を維持。
...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-subaccount-finder-v52-preflight.js?v=5.2.1
...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-subaccount-finder-v52-compact.js?v=5.2.1
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-subaccount-finder-v52-fix1.js?v=5.2.1
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-subaccount-finder-v521-like-state.js?v=5.2.1
// @grant        none
