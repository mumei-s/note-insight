...
// @version      3.6.10
// @description  本人通知V3.6.10。画面を動かさず最大300件を古い順に保存。停止地点から再開し、2回目から差分を反映します。
...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-insight-notification-network-v3300.js?v=3660
...
(function(){
'use strict';
const VERSION='3.6.10',TOOL_KEY='mumei-notification-tool-version',RUNTIME_KEY='mumei-notification-v3-loader',ACTIVE_GM_KEY='mumei-notification-active-runtime-version-v1';
