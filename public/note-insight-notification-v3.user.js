...
// @version      3.4.0
// @description  本人通知V3.4.0。Reader・操作・Filter・Return・Status・Settings・Pair・DMを完全分離。各機能は独立して失敗し、他機能を巻き込みません。
...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-insight-notification-controls-v1.js?v=100
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-insight-notification-filter-v4.js?v=400
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-insight-notification-return-v1.js?v=100
...
(function(){
'use strict';
const VERSION='3.4.0',TOOL_KEY='mumei-notification-tool-version',RUNTIME_KEY='mumei-notification-v3-loader',ACTIVE_GM_KEY='mumei-notification-active-runtime-version-v1';
