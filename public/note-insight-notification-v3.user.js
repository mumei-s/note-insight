...
// @version      3.5.8
// @description  本人通知V3.5.8。自動スクロール300件読込を維持し、4列パネルを画面下部へ固定してnote側の閉じ動作を遮断します。
...
(function(){
'use strict';
const VERSION='3.5.8',TOOL_KEY='mumei-notification-tool-version',RUNTIME_KEY='mumei-notification-v3-loader',ACTIVE_GM_KEY='mumei-notification-active-runtime-version-v1';
