...
// @downloadURL https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-account-audit-force-291.user.js
// @grant none
// @run-at document-start
// ==/UserScript==
(function(){
'use strict';window.__noteAccountAuditV1=1;window.__noteAccountAuditCanonical='2.9.1';
...
function render(r){
 ...
 '<div class="naa-conclusion">'+
   ...
   '<em>'+(act.complete
      ...
      :'活動日データの取得中')+'</em>'+
   '<div class="naa-conclusion-sub">まこ→相手 '+lg.articles+'件｜現フォロワーへ '+lg.followerCreators+'人｜全記事相互 '+lg.followerMutualCreators+'人｜販売型 '+market.score+'/100</div>'+
 '</div>'+
 '<div class="naa-hyp">'+
   '<b>⏸ 停止アカウント仮説</b>'+
