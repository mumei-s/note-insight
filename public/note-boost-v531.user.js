// ==UserScript==
// @name         note 巡回BOOST｜独立版 v5.3.9
// @namespace    https://github.com/mumei-s/note-insight
// @version      5.3.9
// @description  記事URL・マガジンURL・#から巡回。個別記事ではUIを完全非表示、#巡回は実タグ名そのものだけを完全一致採用。周期再描画なし・♡極小ボタン常時維持。
...
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/e8dceac0bfde5e411f950c35f9b6451493c14b70/public/note-boost-v537-prelude.js
// @require      https://raw.githubusercontent.com/mumei-s/note-insight/0d96b1fe045e0e6ef2290a6b5bb5a4c13dafce69/public/note-boost-v538-strict-tag.js
...
(() => {
  'use strict';
  // v5.3.9: #タグ判定を canonical tag name の完全一致だけに限定。
})();
