...
async function openSettings(){
  ...
  p=document.createElement('div');p.id=SETTINGS;(shell&&shell.isConnected?shell:(document.body||document.documentElement)).appendChild(p);for(const type of ['pointerdown','pointerup','click'])p.addEventListener(type,e=>e.stopPropagation());
  const render=()=>{
