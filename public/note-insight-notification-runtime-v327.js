...
async function manualRead(btn){btn.classList.remove('err','done');btn.textContent='読込中';try{await safeScan()}catch(e){btn.classList.add('err');btn.textContent='再読込';btn.title=String(e?.message||e)}finally{keepDockVisible()}}
