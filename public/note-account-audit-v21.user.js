// ==UserScript==
// @name note こあく まこ調査 DASHBOARD v2.1
// @namespace https://github.com/mumei-s/note-insight
// @version 2.1.0
// @description 公開コメント・返信・スキ・フォロー関係とフォロワー構成を確認。本人同定は公開明示だけを根拠にします。
// @match https://note.com/*
// @updateURL https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-account-audit-v21.user.js
// @downloadURL https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-account-audit-v21.user.js
// @grant none
...
var PRESET_TARGET='koakumako',AUTO_KEY='note-account-audit:auto:koakumako:v210';
var PRESET_ARTS=[
...
async function v2FollowPage(id,page){
 var j=await api('/api/v2/creators/'+encodeURIComponent(id)+'/followings?page='+page+'&per=20'),d=o(j.data||j),ls=a(d.follows||d.followers||d.followings||d.users||d.contents||(Array.isArray(j.data)?j.data:[]));
 return ls.map(function(x,i){return rp(x,(page-1)*20+i+1)}).filter(Boolean);
}
