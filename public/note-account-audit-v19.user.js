// ==UserScript==
// @name note こあく まこ調査 TURBO v1.9
// @namespace https://github.com/mumei-s/note-insight
// @version 1.9.0
// @description 公開コメント・返信・スキ・フォロー関係とフォロワー構成を確認。本人同定は公開明示だけを根拠にします。
// @match https://note.com/*
// @updateURL https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-account-audit-v19.user.js
// @downloadURL https://raw.githubusercontent.com/mumei-s/note-insight/main/public/note-account-audit-v19.user.js
// @grant none
...
var PRESET_TARGET='koakumako',AUTO_KEY='note-account-audit:auto:koakumako:v190';
var PRESET_ARTS=[
...
+'<h3>フォロワー全員の共通フォロー先</h3><div class="naa-ev"><b>走査 '+network.scanned+'/'+network.total+'人'+(network.completed?'｜全員完了':'｜途中保存済み')+'</b>'+(network.stopped?'<br>制限検知で停止：次回続きから再開':'')+'</div><small>取得できる公開フォロワーを全員対象。TURBOは4人並列で各フォロワーの公開フォロー先を全件確認し、IndexedDBへ差分保存します。閉じても保存済み位置から再開します。</small>'
